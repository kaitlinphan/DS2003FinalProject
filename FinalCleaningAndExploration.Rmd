...
final_berlin <- kmeans(berlin_spatial_no_outliers, 3, nstart = 25)
...
final_paris <- kmeans(paris_spatial_no_outliers, 3, nstart = 25)
final_paris$cluster <- factor(final_paris$cluster)
final_rome <- kmeans(rome_spatial_no_outliers, 3, nstart = 25)
