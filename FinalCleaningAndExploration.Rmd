...
amsterdam_no_outliers <- subset(amsterdam_spatial, amsterdam_spatial$realSum> (Q1_amsterdam - 1.5*IQR_amsterdam) & amsterdam_spatial$realSum< (Q3_amsterdam + 1.5*IQR_amsterdam))
amsterdam_spatial_no_outliers <- amsterdam_no_outliers[,c(2,13:20)]

athens_spatial <- athens
...
athens_no_outliers <- subset(athens_spatial, athens_spatial$realSum> (Q1_athens - 1.5*IQR_athens) & athens_spatial$realSum< (Q3_athens + 1.5*IQR_athens))
athens_spatial_no_outliers <- athens_no_outliers[,c(2,13:20)]

barcelona_spatial <- barcelona
...
barcelona_no_outliers <- subset(barcelona_spatial, barcelona_spatial$realSum> (Q1_barcelona - 1.5*IQR_barcelona) & barcelona_spatial$realSum< (Q3_barcelona + 1.5*IQR_barcelona))
barcelona_spatial_no_outliers <- barcelona_no_outliers[,c(2,13:20)]

berlin_spatial <- berlin
...
berlin_no_outliers <- subset(berlin_spatial, berlin_spatial$realSum> (Q1_berlin - 1.5*IQR_berlin) & berlin_spatial$realSum< (Q3_berlin + 1.5*IQR_berlin))
berlin_spatial_no_outliers <- berlin_no_outliers[,c(2,13:20)]

budapest_spatial <- budapest
...
budapest_no_outliers <- subset(budapest_spatial, budapest_spatial$realSum> (Q1_budapest - 1.5*IQR_budapest) & budapest_spatial$realSum< (Q3_budapest + 1.5*IQR_budapest))
budapest_spatial_no_outliers <- budapest_no_outliers[,c(2,13:20)]

lisbon_spatial <- lisbon
...
lisbon_no_outliers <- subset(lisbon_spatial, lisbon_spatial$realSum> (Q1_lisbon - 1.5*IQR_lisbon) & lisbon_spatial$realSum< (Q3_lisbon + 1.5*IQR_lisbon))
lisbon_spatial_no_outliers <- lisbon_no_outliers[,c(2,13:20)]

london_spatial <- london
...
london_no_outliers <- subset(london_spatial, london_spatial$realSum> (Q1_london - 1.5*IQR_london) & london_spatial$realSum< (Q3_london + 1.5*IQR_london))
london_spatial_no_outliers <- london_no_outliers[,c(2,13:20)]

paris_spatial <- paris
Q1_paris <- quantile(paris_spatial$realSum, .25)
Q3_paris <- quantile(paris_spatial$realSum, .75)
IQR_paris <- IQR(paris_spatial$realSum)
paris_no_outliers <- subset(paris_spatial, paris_spatial$realSum> (Q1_paris - 1.5*IQR_paris) & paris_spatial$realSum< (Q3_paris + 1.5*IQR_paris))
paris_spatial_no_outliers <- paris_no_outliers[,c(2,13:20)]

rome_spatial <- rome
Q1_rome <- quantile(rome_spatial$realSum, .25)
Q3_rome <- quantile(rome_spatial$realSum, .75)
IQR_rome <- IQR(rome_spatial$realSum)
rome_no_outliers <- subset(rome_spatial, rome_spatial$realSum> (Q1_rome - 1.5*IQR_rome) & rome_spatial$realSum< (Q3_rome + 1.5*IQR_rome))
rome_spatial_no_outliers <- rome_no_outliers[,c(2,13:20)]

vienna_spatial <- vienna
...
vienna_no_outliers <- subset(vienna_spatial, vienna_spatial$realSum> (Q1_vienna - 1.5*IQR_vienna) & vienna_spatial$realSum< (Q3_vienna + 1.5*IQR_vienna))
vienna_spatial_no_outliers <- vienna_no_outliers[,c(2,13:20)]
```
...
fviz_cluster(final_amsterdam, data = amsterdam_spatial_no_outliers, main = "Amsterdam") +
...
fviz_cluster(final_athens, data = athens_spatial_no_outliers, main = "Athens") +
  scale_colour_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
  scale_fill_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
...
fviz_cluster(final_barcelona, data = barcelona_spatial_no_outliers, main = "Barcelona") +
  scale_colour_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
  scale_fill_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
...
fviz_cluster(final_berlin, data = berlin_spatial_no_outliers, main = "Berlin") +
  scale_colour_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
  scale_fill_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
...
fviz_cluster(final_budapest, data = budapest_spatial_no_outliers, main = "Budapest") +
  scale_colour_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
  scale_fill_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
...
fviz_cluster(final_lisbon, data = lisbon_spatial_no_outliers, main = "Lisbon") +
  scale_colour_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
  scale_fill_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
...
fviz_cluster(final_london, data = london_spatial_no_outliers, main = "London") +
  scale_colour_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
  scale_fill_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
...
fviz_cluster(final_paris, data = paris_spatial_no_outliers, main = "Paris") +
  scale_colour_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
  scale_fill_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
...
fviz_cluster(final_rome, data = rome_spatial_no_outliers, main = "Rome") +
  scale_colour_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
  scale_fill_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
...
fviz_cluster(final_vienna, data = vienna_spatial_no_outliers, main = "Vienna") +
  scale_colour_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
  scale_fill_manual(values = c("1"="#ff595e", "2"="#ffca3a", "3"="#1982c4", "4"="#8ac926", 
                                 "5"="#fa7921")) +
